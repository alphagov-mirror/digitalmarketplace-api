...
def sql_compare_date_string(filter_on, date_string):
    ...
    >>> sql_compare_date_string(AuditEvent.created_at, ">=2012-01-01")
    ...
    >>> AuditEvent.query.filter(
        sql_compare_date_string(AuditEvent.created_at, "2010-01-01..2019-01-31"))
